...
var members_1 = require("../models/members"); // Adjust the path as needed
function createMember(name, address, phoneNumber, email) {
    return __awaiter(this, void 0, void 0, function () {
        var newMember, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    error_1 = _a.sent();
                    console.error('Error creating member:', error_1);
                    return [3 /*break*/, 3];
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, members_1.default.findByPk(memberId)];
                case 1:
                    member = _a.sent();
                    if (member) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, member.update(updates)];
                case 2:
                    _a.sent();
                ...
                case 5:
                    error_3 = _a.sent();
                    console.error('Error updating member:', error_3);
                    return [3 /*break*/, 6];
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 5:
                    error_4 = _a.sent();
                    console.error('Error deleting member:', error_4);
                    return [3 /*break*/, 6];
                case 6: return [2 /*return*/];
            }
        });
