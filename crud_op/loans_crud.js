...
var loans_1 = require("../models/loans"); // Adjust the path as needed
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    error_1 = _a.sent();
                    console.error('Error creating loan:', error_1);
                    return [3 /*break*/, 3];
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, loans_1.default.findByPk(loanId)];
                case 1:
                    loan = _a.sent();
                    if (loan) {
                ...
                case 2:
                    error_2 = _a.sent();
                    console.error('Error finding loan:', error_2);
                    return [3 /*break*/, 3];
                case 3: return [2 /*return*/];
            }
        });
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, loan.update(updates)];
                case 2:
                    _a.sent();
                ...
                case 5:
                    error_3 = _a.sent();
                    console.error('Error updating loan:', error_3);
                    return [3 /*break*/, 6];
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 5:
                    error_4 = _a.sent();
                    console.error('Error deleting loan:', error_4);
                    return [3 /*break*/, 6];
                case 6: return [2 /*return*/];
            }
        });
