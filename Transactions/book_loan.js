...
function createLoanTransaction(bookId, memberId, loanDate, dueDate) {
    return __awaiter(this, void 0, void 0, function () {
        var t, book, member, loan, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, con_1.default.transaction()];
                case 1:
                    t = _a.sent();
                    _a.label = 2;
                case 2:
                    _a.trys.push([2, 7, , 9]);
                    return [4 /*yield*/, books_1.default.findByPk(bookId, { transaction: t })];
                case 3:
                    book = _a.sent();
                    if (!book) {
                        throw new Error("Book with id ".concat(bookId, " not found."));
                    }
                    return [4 /*yield*/, members_1.default.findByPk(memberId, { transaction: t })];
                case 4:
                    member = _a.sent();
                    if (!member) {
